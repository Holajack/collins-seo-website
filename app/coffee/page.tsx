...
export const metadata: Metadata = {
  title: "The Perfect Brew — Pour Over, Chemex, AeroPress & Cold Brew Calculator",
  description:
    "Enter the cup size you want and your taste style; get the exact coffee dose, water, bloom, temperature, grind and a live timed pour schedule for V60, Chemex, siphon, AeroPress and cold brew.",
...
export default function CoffeePage() {
  return (
    <div className="c-scope min-h-screen bg-[var(--c-bg)] text-[var(--c-ink)]">
      ...
      {/* Coffee-shop palette + editorial type, scoped so it never touches the
          rest of the site. */}
      <style>{`
        .c-scope {
          --c-bg: #faf6f0;
